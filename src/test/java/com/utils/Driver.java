...
//We cannot do Driver driver = new Driver();
    ...
    We make it static, because we want it to run before everything else, and also we will use it in a static method, ensuressingle copy of the variable/object
     */
    ...
    public static WebDriver getDriver(){
        ...
        if (driver == null){ // if griver was never opened

            /*
            We read our browser type from cion.properties file using
